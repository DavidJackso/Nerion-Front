  ...
  <div :style="{
    ...
    <div style="display: flex; flex-direction: column; min-width: 0">
      ...
      <header :style="{
        ...
        <button @click="showPalette = true" :style="{
          ...
          <span style="font-family: var(--font-mono); font-size: 11px; padding: 1px 5px; background: var(--bg-2); border-radius: 3px; color: var(--fg-2); flex-shrink: 0">⌘K</span>
        </button>

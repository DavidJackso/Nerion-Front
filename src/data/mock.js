...
export const PDF_FORMATS = ['—', 'именительный', 'родительный', 'дательный', 'длинная дата', 'короткая дата', 'инициалы', 'прописью']

export const BIND_TABLES = {
...
export const FILE_TONE = {
  ...
  pptx2: { label: 'PPT', bg: 'var(--amber-50)',    fg: 'var(--amber-700)',   bd: 'var(--amber-100)'       },
}

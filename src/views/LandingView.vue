...
function go(screen) {
  router.push(screen === 'login' ? '/login' : '/register')
}
    ...
    <section class="band band-tint" id="api">
      <div class="wrap api-split">
        ...
        <div class="code-card reveal">
          <div class="code-tabs">
            <button class="ctab" :class="{ active: codeTab === 'curl' }" data-lang="curl" @click="codeTab = 'curl'">cURL</button>
            <button class="ctab" :class="{ active: codeTab === 'js' }" data-lang="js" @click="codeTab = 'js'">JavaScript</button>
            <button class="ctab" :class="{ active: codeTab === 'py' }" data-lang="py" @click="codeTab = 'py'">Python</button>
...
/* .float-badge { position-:absolute;left:-18px;top:15px;background:var(--bg-0);border:0.5px solid var(--border-default);border-radius:8px;box-shadow:var(--shadow-2);padding:3px 5px;display:flex;align-items:center;gap:8px; } */

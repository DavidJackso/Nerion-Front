...
const requestedPath = route.query.from || route.fullPath
</script>
  ...
  <AuthPageLayout>
    <div style="display:flex;flex-direction:column;align-items:center;text-align:center">
      ...
      <div style="width:100%;display:flex;flex-direction:column;gap:10px">
        <NButton variant="primary" size="md" style="width:100%" @click="router.push('/login')">Войти</NButton>
        <NButton variant="secondary" size="md" style="width:100%" @click="router.push('/register')">Создать аккаунт</NButton>
      </div>
